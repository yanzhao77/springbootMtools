...
public class loginController {
    ...
    public ModelAndView login() {
        ...
        if (auth != null) {
            ...
            sysInfoDto.setUserId(String.valueOf(userinfo.getId()));
        }
...
//		modelAndView.setViewName("index");
    ...
    public String logout() {
        ...
        if (auth != null) {
            ...
            sysInfoDto.setUserId(null);
            sysInfoDto.setMainMenu(null);
    ...
    public ModelAndView init(Model model) throws Exception {
        ...
        if (userinfo != null) {
            ...
            if ("alluser".equals(userinfo.getMenuus().trim().toLowerCase())) {
                ...
                sysInfoDto.setMainMenu("userlist");
            ...
            if ("touser".equals(userinfo.getMenuus().trim().toLowerCase())) {
                ...
                sysInfoDto.setMainMenu("toUser");
                modelAndView = new ModelAndView("redirect:/user/toUser");
                modelAndView.addObject("id", userinfo.getId());
            }

            if (sysInfoDto.getMainMenu() == null) {

                throw new Exception("Menu information[" + userinfo.getMenuus().trim() + "] didn't get it.");
            }
        }
        return modelAndView;
    }
